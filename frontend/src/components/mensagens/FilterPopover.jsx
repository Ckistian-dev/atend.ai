        ...
        >
            <div className="p-3">
                        ...
                        <div className="space-y-2">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-2 py-1.5 text-sm rounded-md border border-gray-300 focus:ring-brand-primary focus:border-brand-primary"
                                />
                            </div>
                            <div>
                ...
                <div className="mt-4 pt-3 border-t">
                    <button onClick={handleClear} className="w-full text-center text-sm text-brand-primary hover:underline font-medium">
