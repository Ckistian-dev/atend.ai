                ...
                <div className="flex-1 p-6 overflow-y-auto space-y-6">
                    <div className="text-center">
                        ...
                        <div className="flex items-center justify-center gap-2 mb-1 min-h-[32px] relative">
                            <h2 className="text-xl font-bold text-gray-900 truncate max-w-[220px]">{atendimento.nome_contato || 'Nome do Contato'}</h2>
                            <button onClick={() => setActiveSubMenu(activeSubMenu === 'name' ? null : 'name')} className="p-1.5 text-gray-400 hover:text-brand-primary hover:bg-gray-100 rounded-full transition-colors" title="Editar nome">
                                <Edit size={14} />
                            </button>
                        ...
                        <div className="mt-4 flex justify-center relative" ref={statusRef}>
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={() => setActiveSubMenu(activeSubMenu === 'status' ? null : 'status')} className="p-1.5 text-gray-400 hover:text-brand-primary hover:bg-gray-100 rounded-full transition-colors" title="Alterar situação">
                                    <Edit size={14} />
                                </button>
                            </div>
                                            ...
                                            return (
                                                ...
                                                >
                                                    <span className="flex items-center gap-2">
                                                        ...
                                                        {opt.nome}
                                                        {isStatusActive && <Check size={14} className="ml-auto text-brand-primary" />}
                                                    </span>
                                                </button>
                                            );
                                        })}
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-3">
                            ...
                            {!isEditingObs && (
                                <button onClick={() => setIsEditingObs(true)} className="p-1 text-gray-500 hover:text-brand-primary rounded-full hover:bg-gray-100 transition-colors" title="Editar observações">
                                    <Edit size={16} />
                                </button>
                            )}
                        </div>
                        ...
                        {isEditingObs ? (
                            <div className="space-y-2 animate-fade-in">
                                <textarea
                                    ...
                                    className="w-full p-2 text-sm border border-gray-300 rounded-md focus:ring-brand-primary focus:border-brand-primary min-h-[100px] resize-none overflow-hidden"
                                ...
                                <div className="flex justify-end gap-2">
                                    ...
                                    <button onClick={handleSaveObs} className="px-3 py-1.5 text-xs font-medium text-white bg-brand-primary rounded-md hover:bg-brand-primary-active">Salvar</button>
                                </div>
                            </div>
                        ) : (
                    ...
                    <div className="relative">
                        <div className="flex items-center justify-between mb-3">
                            ...
                            <button onClick={() => setActiveSubMenu(activeSubMenu === 'tags' ? null : 'tags')} className="p-1 text-gray-500 hover:text-brand-primary rounded-full hover:bg-gray-100 transition-colors" title="Editar tags">
                                <Edit size={16} />
                            </button>
                        </div>
