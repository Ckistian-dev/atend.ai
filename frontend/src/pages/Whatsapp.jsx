...
// Componente de UI refatorado para o novo design
            ...
            case 'open':
                return (
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">A sua instância está online e pronta.</p>
        ...
        <div>
            ...
            <div className="border-t border-gray-200 pt-4 mt-4 text-center">
                <button onClick={onRefresh} disabled={isChecking} className="flex items-center justify-center gap-2 mx-auto text-sm text-gray-500 hover:text-brand-blue font-semibold disabled:opacity-50">
                    {isChecking ? <><Loader2 size={16} className="animate-spin" /> A verificar...</> : <><RefreshCw size={16} /> Atualizar Status</>}
                </button>
            </div>
        </div>
    );
...
function Whatsapp() {
    ...
    // As funções (checkStatus, handleConnect, etc.) permanecem exatamente as mesmas do projeto original.
    // ... (cole aqui as funções handleConnect, handleDisconnect, handleSaveInstanceName, checkStatus e os useEffects do seu ficheiro Whatsapp.jsx original)
    ...
    }, [instanceName, isEditing, checkStatus]);
    ...
    return (
        <div className="p-6 md:p-10 bg-gray-50 min-h-full">
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-1">Faça a gestão da sua conexão com a API do WhatsApp.</p>
            </div>
