    ...
    const Section = ({ icon, title, children }) => (
        <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
                <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-brand-primary">
                    {icon}
                </div>
            ...
            {report.proximos_passos_recomendados && (
                <Section icon={<Zap size={16} />} title="Próximos Passos Recomendados">
                    <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-100 rounded-lg">
                        <ArrowRight size={20} className="text-brand-primary mt-0.5 flex-shrink-0" />
...
const DateRangeFilter = ({ onDateChange }) => {
    ...
    return (
        <div className="relative">
            ...
            {showCustomPicker && (
                <div className="absolute top-full right-0 mt-2 bg-white p-4 rounded-xl shadow-lg border border-gray-200 z-20 w-70">
                    ...
                    <div className="flex justify-end gap-2 mt-3">
                        ...
                        <button
                            ...
                            className="px-3 py-1.5 text-sm text-white bg-brand-primary rounded-md hover:bg-brand-primary-active disabled:bg-blue-300"
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 mt-8">
            ...
            <div className="mb-4 flex items-center gap-6">
                ...
                <div className="flex items-center gap-4">
                    <label className="flex items-center gap-2 cursor-pointer text-sm text-gray-600">
                        <input type="checkbox" checked={selectedContexts.includes('atendimentos')} onChange={() => handleContextChange('atendimentos')} className="h-4 w-4 rounded border-gray-300 text-brand-primary focus:ring-brand-primary" />
                        Atendimentos no Período
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer text-sm text-gray-600">
                        <input type="checkbox" checked={selectedContexts.includes('persona')} onChange={() => handleContextChange('persona')} className="h-4 w-4 rounded border-gray-300 text-brand-primary focus:ring-brand-primary" />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                <input
                    ...
                    className="flex-grow px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-primary"
                    disabled={isLoading}
                />
                <button type="submit" className="px-6 py-3 bg-brand-primary text-white rounded-lg font-semibold hover:bg-brand-primary-active transition-colors flex items-center gap-2 disabled:bg-blue-300" disabled={isLoading}>
                ...
                <div className="flex flex-wrap gap-2">
                    {predefinedQuestions.map((q, index) => (
                        <button
                            ...
                            className="flex items-center gap-2 text-sm text-brand-primary-active bg-blue-50 px-3 py-1.5 rounded-full hover:bg-blue-100 hover:text-blue-800 transition-colors"
                        >
                            <Lightbulb size={14} />
                            <span>{q}</span>
                        </button>
...
const Dashboard = () => {
    ...
    return (
        <div className="p-6 md:p-8 bg-gray-50 min-h-full">
            ...
            {isLoading && <div className="absolute inset-0 bg-white/50 flex items-center justify-center z-10"><Loader2 size={32} className="animate-spin text-brand-primary" /></div>}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                        ...
                        <div className="lg:col-span-2 space-y-8 flex flex-col">
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                <StatCard icon={<TrendingUp size={28} className="text-brand-primary" />} label={data.stats?.totalAtendimentos?.label} value={data.stats?.totalAtendimentos?.value} color="bg-blue-100" />
